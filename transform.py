...
#--------------------------------------------------------------------------------------------------
#col_assign.update({'MEMBERSHIP_TERM_YEARS':[[None],['std_sc','mm_sc']]})
col_assign.update({'MEMBERSHIP_TERM_YEARS':[[None],['std_sc','mm_sc']]})
...
col_assign.update({'MEMBER_ANNUAL_INCOME':[['avg_imp'],['std_sc','mm_sc']]})
...
col_assign.update({'MEMBER_AGE_AT_ISSUE':[[None],['std_sc','mm_sc']]})
